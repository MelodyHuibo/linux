...
TRACE_EVENT(kvm_inj_virq,
	TP_PROTO(struct kvm_vcpu *vcpu, unsigned int vector, bool soft, bool reinjected),
	TP_ARGS(vcpu, vector, soft, reinjected),
...
TRACE_EVENT(kvm_inj_exception,
	TP_PROTO(struct kvm_vcpu *vcpu, unsigned exception, bool has_error, unsigned error_code,
		 bool reinjected),
	TP_ARGS(vcpu, exception, has_error, error_code, reinjected),
